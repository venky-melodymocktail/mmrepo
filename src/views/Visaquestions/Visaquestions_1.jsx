                            ...
                            >
...

                                {
                                    ...
                                    <div style={{
                                        ...
                                        <img style={{width:"220px", height:"150px"}} src="https://melodymocktail.blob.core.windows.net/website/mmAwsImagesBucket/5d758444-22d0-4461-b6e0-abde5e77a890.png"/>
                                        <div style={{
                                            color:"#3C0608",
                                            fontSize:"40px",
                                            fontWeight:500,
                                        ...
                                        <div style={{
                                            ...
                                            Your question has successfully posted, you will be notified once you receive a comment.
                                        </div>
                                        <div 
                                        onClick={()=>{
                                    ...
                                    <div style={{
                                        ...
                                        </div>
                                        {
                                            ...
                                            <div style={{
                                                ...
                                                {
                                                    dl.changes.showvisaQuestionSuggestion?
                                                    <div style={{
                                                        color:"#7F1D1D",
                                                        fontSize:18,
                                                        fontWeight:500,
                                                        ...
                                                        Melody Mockt<a style={{fontWeight:700}}>AI</a>l
                                                    </div>
                                                    :
                                                    null
                                                }
                                            ...
                                            <div onClick={(e) => {
                                                    ...
                                                    if (userToken) {
                                                        ...
                                                        if (
                                                            ...
                                                            // dl.functions.getQuestionSuggestion()
                                                            dl.functions.createVisaQuestion(false)
                                                        }
                                                    } else {
                                                        dl.functions.modalsPlugin.openModal(
                                                            'loginLg'
                                                ...
                                                onClick={(e) => {
                                                    ...
                                                    if (userToken) {
                                                        ...
                                                        if (
                                                            ...
                                                            // dl.functions.getQuestionSuggestion()
                                                            dl.functions.createVisaQuestion(true)
                                                        }
                                                    } else {
                                                        dl.functions.modalsPlugin.openModal(
                                                            'loginLg'
