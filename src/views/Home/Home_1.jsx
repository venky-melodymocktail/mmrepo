                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                      <a style={{fontWeight:"400", color:"rgba(140, 44, 35,1)", fontSize:25}}>Recently Uploaded</a> Rental <a style={{fontWeight:"400",  color:"rgba(140, 44, 35,1)", fontSize:25}}>posts</a>
                                </div>
                                <div
                                    style={{
                                        width: '90%',
                            ...
                            >
                                ...
                                >
                                    <a style={{fontWeight:"400", color:"rgba(140, 44, 35,1)", fontSize:25}}>Recently Uploaded</a> Travel Companion <a style={{fontWeight:"400",  color:"rgba(140, 44, 35,1)", fontSize:25}}>posts</a>
                                </div>
                                <div
                                    style={{
                                        width: '90%',
